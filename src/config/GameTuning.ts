...
export const DEFAULT_GAME_TUNING: GameTuning = {
  vehicle: {
    baseAcceleration: 18.5,
    reverseAcceleration: 9.2,
    gravity: 24,
    ...
    suspensionSpring: 54,
    suspensionDamping: 58,
    airControl: 0.03,
    airTurnControl: 0.08,
    maxCruiseSpeed: 34,
    maxBoostSpeed: 44,
    boostMultiplier: 1.35,
    boostDrainPerSecond: 0.22,
    boostRegenPerSecond: 0.13,
    coastDragBase: 0.72,
    brakeForwardBase: 6.5,
    brakeLateralBase: 7.2,
    dragVelocityFactor: 0.016,
